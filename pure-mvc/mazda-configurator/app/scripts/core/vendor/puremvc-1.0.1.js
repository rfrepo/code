...
(function (scope) {
     ...
     *
     * PureMVC does not rely upon underlying event model_thumnbnail such as the one provided
     * with the DOM or other browser centric W3C event model_thumnbnail.
     *
 ...
 *         }
    ...
    scope.puremvc =
    {
        View: View, Model: Model, Controller: Controller, SimpleCommand: SimpleCommand, MacroCommand: MacroCommand, Facade: Facade, Mediator: Mediator, Observer: Observer, Notification: Notification, Notifier: Notifier, Proxy: Proxy, define: define, declare: declare
    };
