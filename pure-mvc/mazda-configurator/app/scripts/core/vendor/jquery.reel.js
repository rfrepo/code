                            ...
                            // Quick data interface
                                ...
                                on= {
                                    ...
                                    setup: function(e){
                                        ...
                                        //BURROWS MOD FOR FRAME/SPRITESHEET SEPERATION - start
                                        var extension = src.substr(src.length - 4),
                                            newSrc = src.slice(0, (-1 * (opt.premove.length+4)) ) + extension;
                                        src = newSrc.replace(reel.re.image, '$1' + opt.suffix + '.$2');
                                        set(_image_, images.length ? __ : opt.image || src);
                                        //BURROWS MOD FOR FRAME/SPRITESHEET SEPERATION - end
                                        set(_cached_, []);
